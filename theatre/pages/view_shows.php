  ...
  <body>
    ...
    <main>
      ...
      <div class="main_content">
        <div class="heading">View Shows</div>
              ...
              while($shows=mysqli_fetch_array($sw))
              {
                ...
                <tr>
                  ...
                  <td>
                    ...
                    {
                    ?><a href="change_running.php?id=<?php echo $shows['s_id'];?>&status=0"><button id="stop_running" >Stop Running</button></a>
                    <?php
                    }
                    else
                    {?><a href="change_running.php?id=<?php echo $shows['s_id'];?>&status=1"><button id="stop_running"style='background-color:green;' >Start Running</button> </a>
                    <?php 
                    }?>
                    <a href="stop_running.php?id=<?php echo $shows['s_id'];?>"><button id="stop_show">Stop Show</button></a>
                  </td>
                </tr>
                <?php
              }
