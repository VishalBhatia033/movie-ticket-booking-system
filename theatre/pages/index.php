  ...
  <body>
    ...
    <main>
      ...
      <div class="main_content">
        <div class="heading">Running Movies</div>
        <div class="movie_container">
          ...
          <table class="table table-condensed">
                ...
                <?php 
					$qry8=mysqli_query($conn,"select * from tbl_shows where r_status=1 and theatre_id='".$_SESSION['theater_id']."'");
					$no=1;
					while($mn=mysqli_fetch_array($qry8))
					{
					 $qry9=mysqli_query($conn,"select * from tbl_movie where movie_id='".$mn['movie_id']."'");
					 $mov=mysqli_fetch_array($qry9);
					 $qry10=mysqli_query($conn,"select * from tbl_show_time where st_id='".$mn['st_id']."'");
					 $scr=mysqli_fetch_array($qry10);
					 $qry11=mysqli_query($conn,"select * from tbl_screens where screen_id='".$scr['screen_id']."'");
					 $scn=mysqli_fetch_array($qry11);
					?>
                <tr>
                  <td><?php echo $no;?></td>
                  <td><span class="screen_cell"><?php echo $scn['screen_name'];?></span></td>
                  <td><span class="time_cell"><?php echo $scr['start_time'];?>(<?php echo $scr['name'];?>)</span></td>
