...
<html>
  ...
  <body
    ...
    style="
      background-image: url(../project_images/b14.jpg);
  ...
  >
    <div
      class="login-box"
      style="background-color: transparent; border-radius: 0.5rem"
    >
      ...
      >
       ...
       if($_SERVER['REQUEST_METHOD']=='POST'){
         ...
         $result = $conn->query("SELECT * FROM tbl_login WHERE username='$email' AND password='$password' AND user_type='1'");
         if($result->num_rows>0){
           $row=$result->fetch_assoc();
           $_SESSION['theater_id']=$row['user_id'];
